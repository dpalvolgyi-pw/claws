...
## Supported Services (65 services, 148 resources)

### Compute
| Service | Resources |
|---------|-----------|
| EC2 | Instances, Volumes, Security Groups, VPCs, Subnets, Route Tables, Internet Gateways, NAT Gateways, Elastic IPs, Key Pairs, AMIs, Snapshots, Launch Templates |
| Lambda | Functions |
...
| Service | Resources |
|---------|-----------|
| VPC | VPC Endpoints, Transit Gateways, TGW Attachments |
